...
<ul class="nav nav-tabs">
	...
	<li role="presentation" class="active"><a href="<?php echo U('set');?>">管理设置</a></li>
</ul>
<div id="lunch">
		<h3>午餐</h3>
	<hr />
	<div class="pull-right">
		<!--<?php if($config[1]["configname"]): else: endif; ?>-->
		<input type="checkbox" name="lunchswitch" data-id="<?php echo ($config['lunch_on']); ?>" checked>
	</div>
	<h4>是否开启午餐</h4>
	<hr />
	<div id="islunch">
		...
		<div id="islunchauto">
			<div class="pull-right">
				<label>10:00</label><span class="badge primary"><span class="glyphicon glyphicon-edit"></span></span>
			</div>
			...
			<hr />
			<div class="pull-right">
				<label>12:00</label><span class="badge primary"><span class="glyphicon glyphicon-edit"></span></span>
			</div>
...
<div id="dinner">
	...
	<div id="isdinner">
		...
		<div id="isdinnerauto">
			<div class="pull-right">
				<label>16:00</label><span class="badge primary"><span class="glyphicon glyphicon-edit"></span></span>
			</div>
			<!--<div class="form-inline">
				<div class="form-group">
			...
			<hr />
			<div class="pull-right">
				<label>18:00</label><span class="badge primary"><span class="glyphicon glyphicon-edit"></span></span>
			</div>
			<!--<div class="form-inline">
				<div class="form-group">
...
//	var config = "<?php echo $config;?>";
	$("[name='lunchswitch']").attr('checked',false);
